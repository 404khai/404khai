...
### Tech Stack  
```bash
Languages:   JavaScript | TypeScript | Php | Java | Dart | Python | Go | Rust | C#
Frameworks:  React | Next.js | Vue | Svelte | Express | Nest.js | SpringBoot | Flutter | FastAPI | Django | Symphony | Laravel
